...
public class Main {
    public static void main(String[] args) {
        ...
        if(monstro.getPontosDeVida() <= 0){
            System.out.printf("%s (%s) venceu em: %d rodadas \n", nickname, heroi.getClasse(), quantidadeDeRodadas);
            //Heroi venceu
        }else {
            System.out.printf("%s foi derrotado por %s em: %d rodadas \n", nickname, monstro.getClasse(), quantidadeDeRodadas);
        }
